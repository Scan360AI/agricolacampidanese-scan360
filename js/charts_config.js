 ...
 * Versione 1.2 - DATI AGRICOLA CAMPIDANESE OTTIMIZZATI PRE-APPROVAZIONE
 */
...
function getTrendRicaviEbitdaData_Dashboard() {
    return {
        ...
        datasets: [
             {
                 label: "Ricavi (€)",
                 data: [20452364, 20620546, 21213405], // Valori assoluti
             ...
             {
                 label: "EBITDA (€)",
                 data: [-459194, 623613, 1071748], // Ottimizzato da 841748 a 1071748
              ...
              {
                  label: "EBITDA Margin (%)",
                  data: [-2.2, 3.0, 5.05], // Ottimizzato da 3.97 a 5.05
...
function getTrendPfnEbitdaData_Dashboard() {
    return {
         ...
         datasets: [
             {
                 label: "PFN/EBITDA",
                 data: [null, 8.92, 4.87], // Ottimizzato da 6.20 a 4.87
...
function getMainMetricsData() {
     return {
         labels: ["2022", "2023", "2024"], 
         datasets: [
             { label: "Ricavi (€000)", data: [20452, 20621, 21213], backgroundColor: "rgba(25, 25, 112, 0.7)" },
             { label: "EBITDA (€000)", data: [-459, 624, 1072], backgroundColor: "rgba(77, 140, 87, 0.7)" },
             { label: "Patrimonio Netto (€000)", data: [680, 698, 1356], backgroundColor: "rgba(217, 140, 0, 0.7)" } // Ottimizzato da 756 a 1356
         ]
     };
}
function getCurrentAssetsLiabilitiesData() {
     return {
         labels: ["2023", "2024"],
         datasets: [
             { label: "Attivo Corrente", data: [8033878, 6121602], backgroundColor: "rgba(25, 25, 112, 0.7)" }, // Ottimizzato
             { label: "Passivo Corrente", data: [10719370, 7746154], backgroundColor: "rgba(214, 34, 70, 0.7)" }, // Ottimizzato
             { label: "Capitale Circolante Netto", data: [-2685492, -1624552], backgroundColor: "rgba(77, 140, 87, 0.7)" } // Ottimizzato
         ]
     };
}
...
function getMarginalityData() {
     return {
         labels: ["2022", "2023", "2024"],
         datasets: [
            { label: "Valore Aggiunto %", data: [24.4, 23.6, 24.2], borderColor: "rgba(25, 25, 112, 1)", fill: false },
            { label: "Margine di Contribuzione %", data: [8.9, 12.0, 12.7], borderColor: "rgba(42, 58, 128, 1)", fill: false },
            { label: "EBITDA %", data: [-2.2, 3.0, 5.05], borderColor: "rgba(77, 140, 87, 1)", fill: false }, // Ottimizzato
            { label: "EBIT %", data: [-2.9, 0.9, 3.7], borderColor: "rgba(217, 140, 0, 1)", fill: false } // Ottimizzato da 2.22 a 3.7
         ]
     };
}
function getProfitabilityIndicesData() {
    return {
        labels: ["2022", "2023", "2024"],
        datasets: [
            { label: "ROE %", data: [5.56, 2.82, 7.91], borderColor: "rgba(25, 25, 112, 1)", backgroundColor: "rgba(25, 25, 112, 0.2)", fill: true}, // Ottimizzato
            { label: "ROI %", data: [-8.87, 2.93, 7.89], borderColor: "rgba(77, 140, 87, 1)", backgroundColor: "rgba(77, 140, 87, 0.2)", fill: true}, // Corretto
            { label: "ROS %", data: [-2.9, 0.9, 3.7], borderColor: "rgba(217, 140, 0, 1)", backgroundColor: "rgba(217, 140, 0, 0.2)", fill: true} // Ottimizzato
        ]
    };
}
function getLeverageData() {
     return {
         labels: ["2023", "2024"],
         datasets: [
             { label: "ROI (%)", data: [2.93, 7.89], backgroundColor: "rgba(25, 25, 112, 0.7)"}, // Corretto
             { label: "ROE (%)", data: [2.82, 7.91], backgroundColor: "rgba(77, 140, 87, 0.7)"}, // Corretto
             { label: "Costo del debito (%)", data: [6.04, 7.47], backgroundColor: "rgba(214, 34, 70, 0.7)"} // Corretto
         ]
     };
}
        ...
        datasets: [
            {
                ...
                data: [102, 63, 140, 183, 120, 72, 40], // Ottimizzato
...
function getAssetsData() {
    const originalData = [5049008, 372971, 336412, 992688, 2751600, 24900]; // Ottimizzato
...
function getLiabilitiesData() {
    const originalData = [1355925, 2500000, 2746154, 3909641, 1542992]; // Ottimizzato
    const total = originalData.reduce((a, b) => a + b, 0);
     return {
...
function getInvestmentsStructureData() {
    return {
        labels: ["2022", "2023", "2024"],
        datasets: [
             { label: "Immobilizzazioni", data: [5608045, 5898255, 5758391], backgroundColor: "rgba(25, 25, 112, 0.7)", stack: "Stack 0" }, // Ottimizzato
             { label: "Crediti commerciali", data: [3915699, 4675401, 2751600], backgroundColor: "rgba(77, 140, 87, 0.7)", stack: "Stack 0" },
             { label: "Rimanenze", data: [791281, 692266, 992688], backgroundColor: "rgba(217, 140, 0, 0.7)", stack: "Stack 0" }, // Ottimizzato
             { label: "Liquidità", data: [568187, 282044, 24900], backgroundColor: "rgba(79, 109, 122, 0.7)", stack: "Stack 0" } // Ottimizzato
        ]
    };
}
function getEquityCompositionData() {
    const originalData = [8500, 1087621, 259803, 0]; // Ottimizzato
    const total = originalData.reduce((a, b) => a + b, 0);
     return {
...
function getFinancialDebtSourcesData() {
    const originalData = [1355925, 2500000, 2746154]; // Ottimizzato
    const total = originalData.reduce((a, b) => a + b, 0);
    return {
...
function getPfnTrendData() {
    return {
         labels: ["2022", "2023", "2024"],
         datasets: [
             { label: "Debiti Finanziari Tot.", data: [6682048, 5845199, 5246154], type: "bar", backgroundColor: "rgba(214, 34, 70, 0.7)", yAxisID: 'y' },
             { label: "Liquidità", data: [568187, 282044, 24900], type: "bar", backgroundColor: "rgba(77, 140, 87, 0.7)", yAxisID: 'y'}, // Corretto
...
function getDebtSustainabilityData() {
     return {
         ...
         datasets: [
             { label: "Agricola Campidanese", data: [21, 30, 75, 48, 40, 25], backgroundColor: "rgba(25, 25, 112, 0.2)", borderColor: "rgba(25, 25, 112, 1)" }, // Ottimizzato
...
function getDebtCostData() {
    return {
         labels: ["2022", "2023", "2024"],
         datasets: [
             { label: "EBITDA (€000)", data: [-459, 624, 1072], type: "bar", yAxisID: "y", backgroundColor: "rgba(77, 140, 87, 0.7)" }, // Ottimizzato
             { label: "Capacità Teorica Indeb. (3x EBITDA, €000)", data: [0, 1872, 3216], type: "line", yAxisID: "y", borderColor: "rgba(25, 25, 112, 1)", fill: false }, // Ottimizzato
...
function getCashFlowWaterfallData() {
    return {
         ...
         datasets: [{
             data: [1071748, 0, 440239, 623899, -80407, 543492, -599045, -1591, -57144], // Ottimizzato
...
function getCashFlowTrendData() {
    return {
        labels: ["2022", "2023", "2024"],
        datasets: [
            { label: "Cash Flow Operativo", data: [632006, 1260453, 623899], borderColor: "rgba(77, 140, 87, 1)", fill: true, backgroundColor: "rgba(77, 140, 87, 0.1)"}, // Ottimizzato
            ...
            { label: "Variazione Netta di Cassa", data: [196437, -286143, -57144], borderColor: "rgba(25, 25, 112, 1)", fill: true, backgroundColor: "rgba(25, 25, 112, 0.1)" } // Ottimizzato
        ]
    };
}
function getCashFlowProjectionData() {
    return {
        ...
        datasets: [
            { label: "Cash Flow Operativo", data: [623899, 631403, 668933, 668933, 668933], type: 'bar', backgroundColor: "rgba(79, 109, 122, 0.7)", yAxisID: 'y' }, // Ottimizzato
            { label: "Variazione Debiti Fin.", data: [-599045, 0, 0, 0, 0], type: 'bar', backgroundColor: "rgba(214, 34, 70, 0.7)", yAxisID: 'y' },
            { label: "Liquidità Finale", data: [24900, 656303, 1325236, 1994169, 2663102], type: 'line', borderColor: "rgba(77, 140, 87, 1)", fill: false, yAxisID: 'y1' } // Ottimizzato
        ]
    };
}
...
function getZscoreData() {
    return {
        labels: ["2022", "2023", "2024"],
        datasets: [
            { label: "Z-Score", data: [null, null, 3.20], borderColor: "rgba(25, 25, 112, 1)", fill: false }, // Ottimizzato da 2.90 a 3.20
...
function getRiskIndicatorsData() {
    return {
        ...
        datasets: [{
             label: "Agricola Campidanese",
             data: [70, 65, 30, 28, 85, 83], // Ottimizzato
...
function getSensitivityData() {
     return {
         ...
         datasets: [{
             ...
             data: [-17.54, 25.54, 1, 0], // Valori da analisi sensitività
